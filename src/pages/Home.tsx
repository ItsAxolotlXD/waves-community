            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <div className="relative group p-[2px] rounded-full overflow-hidden inline-flex shadow-[0_0_20px_rgba(88,101,242,0.35)] hover:shadow-[0_0_30px_rgba(255,51,153,0.6)] transition-all">
                ...
                <a
                  ...
                  className="relative flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#13131c] hover:bg-[#1a1a26] text-white text-xs font-bold transition-all cursor-pointer"
                >
                  <svg className="w-4 h-4 fill-current text-[#7289DA] group-hover:text-white transition-colors" viewBox="0 0 24 24">
